...
class DialogueManager:
    ...
    _rl_agent (RLAgent) -> The reinforcement learning agent.
    _rb_agent (RBAgent) -> The rule-based agent.
    ...
    def empty_rl_mem(self, fraction=1):
        ...
        del self.rl_mem[:int(len(self._rl_memory) * fraction)]
